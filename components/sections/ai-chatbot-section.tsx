    ...
    <section className="flex items-center justify-center py-16 bg-white">
      <div className="w-full max-w-2xl flex flex-col gap-6 items-start px-4">
          ...
          <p className="text-lg text-gray-600 max-w-2xl text-left">
            L'intelligence artificielle de Justice.cool est là pour vous aider à trouver votre chemin afin de résoudre vos contentieux
          </p>
          <div className="bg-gray-50 rounded-4xl w-full space-y-2 px-6 py-4">
          ...
          <div className="flex flex-wrap items-center justify-center gap-2">
            {[
              ...
              <span
                ...
                className="bg-gray-50 hover:bg-gray-100 text-gray-600 inline-block cursor-pointer rounded-full px-4 py-1 text-xs tracking-tight"
              >
                {item}
              </span>
            ))}
